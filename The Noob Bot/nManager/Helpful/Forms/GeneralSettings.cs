    ...
    public partial class GeneralSettings : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        void SaveSetting()
        {
            try
            {
                ...
                nManagerSetting.CurrentSetting.groundName = groundName.Text;
                ...
                nManagerSetting.CurrentSetting.aquaticName = aquaticName.Text;
        ...
        void LoadSetting(nManagerSetting managerSetting)
        {
            try
            {
                ...
                groundName.Text = managerSetting.groundName;
                ...
                aquaticName.Text = managerSetting.aquaticName;
