    ...
    public partial class Developer_Tools : DevComponents.DotNetBar.Metro.MetroForm
    {
            ...
            try
            {
                ...
                if (ObjectManager.Target.IsValid)
                {
                    ...
                    infoTb.Text =
                        ...
                        "    </Position>" + Environment.NewLine +
                        "    <Faction>" + (Npc.FactionType)Enum.Parse(typeof(Npc.FactionType), ObjectManager.Me.PlayerFaction, true) + "</Faction>" + Environment.NewLine +
                        "    <Type>None</Type>" + Environment.NewLine +
                        "    <ContinentId>" + (Wow.Enums.ContinentId)(Usefuls.ContinentId) + "</ContinentId>" + Environment.NewLine +
                        "  </Npc>";
                }
            }
            catch (Exception ex)
        ...
        internal void LoadScript()
        {
            try
            {
                ...
                CompilerResults cr = cc.CompileAssemblyFromSource(cp, " public class Main : nManager.Helpful.Interface.IScriptOnlineManager { public void Initialize() { " + infoTb.Text + " } } ");
