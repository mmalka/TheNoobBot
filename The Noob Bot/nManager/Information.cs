namespace nManager
{
    ...
    {
        public const string TargetWowVersion = "7.2.5";
        public const int TargetWowBuild = 24415;
        public const int MinWowBuild = 17128 + 1; // no need to update it
        public const int MaxWowBuild = 26000; // not to be changed until we are closer
        ...
        public const string Version = "MD5HashVersionForDev"; // current = 7.0.4 vs MD5HashVersionForDev
