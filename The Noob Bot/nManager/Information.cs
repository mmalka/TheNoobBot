namespace nManager
{
    ...
    {
        public const string TargetWowVersion = "6.0.3";
        public const int TargetWowBuild = 19116;
        ...
        public const string Version = "DevVersionRestrict"; // current = 4.1.4 vs DevVersionRestrict
