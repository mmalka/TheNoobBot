namespace nManager
{
    ...
    {
        public const string TargetWowVersion = "5.4.2";
        public const int TargetWowBuild = 17688;
        ...
        public const string Version = "DevVersionRestrict"; // current = 2.5.0
        public static string MainTitle = "The Private Bot " + Version;
    }
}