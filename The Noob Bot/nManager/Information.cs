namespace nManager
{
    ...
    {
        public const string TargetWowVersion = "6.0.2";
        public const int TargetWowBuild = 19034;
        ...
        public const string Version = "DevVersionRestrict"; // current = 4.0.6 vs DevVersionRestrict
