namespace nManager
{
    ...
    {
        public const string TargetWowVersion = "6.1.0";
        public const int TargetWowBuild = 19678;
        ...
        public const string Version = "DevVersionRestrict"; // current = 4.3.3 vs DevVersionRestrict
