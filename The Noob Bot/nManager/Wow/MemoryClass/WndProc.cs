...
namespace nManager.Wow.MemoryClass
{
    ...
    public class WndProcExecutor : IDisposable
    {
        ...
        static extern IntPtr SendMessage(IntPtr p_Hwnd, uint p_Msg, IntPtr p_WParam, IntPtr p_LParam);

        [DllImport("kernel32", CharSet = CharSet.Ansi)]
        static extern IntPtr GetProcAddress(IntPtr p_Module, string p_ProcName);

        [DllImport("kernel32.dll", CharSet = CharSet.Ansi)]
        static extern IntPtr GetModuleHandle(string p_ModuleName);
        ...
        public WndProcExecutor(RemoteProcess p_Process, IntPtr p_Windowhandle)
        {
