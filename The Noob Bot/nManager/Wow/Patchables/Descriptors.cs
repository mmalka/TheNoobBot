namespace nManager.Wow.Patchables
{
    ...
    public static class Descriptors
    {
        ...
        public enum PlayerFields
        {
            ...
            ParryPercentage = 0x90F,
            CritPercentage = 0x910,
            RangedCritPercentage = 0x911,
            OffhandCritPercentage = 0x912,
            SpellCritPercentage = 0x913,
            ShieldBlock = 0x914,
            ShieldBlockCritPercentage = 0x915,
            Mastery = 0x916,
            Speed = 0x917,
            Lifesteal = 0x918,
            Avoidance = 0x919,
            Sturdiness = 0x91A,
            Versatility = 0x91B,
            VersatilityBonus = 0x91C,
            PvpPowerDamage = 0x91D,
            PvpPowerHealing = 0x91E,
            ExploredZones = 0x91F,
            RestInfo = 0xA1F,
            ModDamageDonePos = 0xA23,
            ModDamageDoneNeg = 0xA2A,
            ModDamageDonePercent = 0xA31,
            ModHealingDonePos = 0xA38,
            ModHealingPercent = 0xA39,
            ModHealingDonePercent = 0xA3A,
            ModPeriodicHealingDonePercent = 0xA3B,
            WeaponDmgMultipliers = 0xA3C,
            WeaponAtkSpeedMultipliers = 0xA3F,
            ModSpellPowerPercent = 0xA42,
            ModResiliencePercent = 0xA43,
            OverrideSpellPowerByAPPercent = 0xA44,
            OverrideAPBySpellPowerPercent = 0xA45,
            ModTargetResistance = 0xA46,
            ModTargetPhysicalResistance = 0xA47,
            LocalFlags = 0xA48,
            NumRespecs = 0xA49,
            SelfResSpell = 0xA4A,
            PvpMedals = 0xA4B,
            BuybackPrice = 0xA4C,
            BuybackTimestamp = 0xA58,
            YesterdayHonorableKills = 0xA64,
            LifetimeHonorableKills = 0xA65,
            WatchedFactionIndex = 0xA66,
            CombatRatings = 0xA67,
            PvpInfo = 0xA87,
            MaxLevel = 0xAAB,
            ScalingPlayerLevelDelta = 0xAAC,
            MaxCreatureScalingLevel = 0xAAD,
            NoReagentCostMask = 0xAAE,
            PetSpellPower = 0xAB2,
            Researching = 0xAB3,
            ProfessionSkillLine = 0xABD,
            UiHitModifier = 0xABF,
            UiSpellHitModifier = 0xAC0,
            HomeRealmTimeOffset = 0xAC1,
            ModPetHaste = 0xAC2,
            OverrideSpellsID = 0xAC3,
            LfgBonusFactionID = 0xAC4,
            LootSpecID = 0xAC5,
            OverrideZonePVPType = 0xAC6,
            BagSlotFlags = 0xAC7,
            BankBagSlotFlags = 0xACB,
            InsertItemsLeftToRight = 0xAD2,
            QuestCompleted = 0xAD3,
            Honor = 0xE3E,
            HonorNextLevel = 0xE3F,
        };
