...
*/
        ...
        public void HealingBurst()
        {
                ...
                && _mySettings.UseEngGlove)
            {
                ...
                _engineeringTimer = new Timer(1000 * 60); return;
            }
